...
export const Comment = ({
    ...
    useEffect(() => {
        const fetchUserInteraccion = async () => {
            ...
            try {
                ...
                if (error) {
                    console.error(
                        "Error al obtener la interacción del usuario:",
                        error
                    );
                    return;
                }
                ...
                if (data.length > 0) {
                    setUserInteraccion(
                        data[0].tipo_interaccioncomentario.toString()
                    );
                } else {
                ...
                console.error(
                    "Error inesperado al obtener interacciones:",
                    err
                );
            }
        };
    ...
    const handleInteraccion = async (tipoInteraccion) => {
        ...
        if (!user) {
            alert(
                "Por favor, inicia sesión para interactuar con este comentario."
            );
            return;
        }
        ...
        try {
            if (userInteraccion === tipoInteraccion) {
                ...
                if (deleteError) {
                    console.error(
                        "Error al eliminar interacción previa:",
                        deleteError
                    );
                    return;
                }
                ...
                if (!upsertError) {
                    ...
                    console.error(
                        "Error al insertar nueva interacción:",
                        upsertError
                    );
                }
            }
        ...
        <div className="py-5 px-8 bg-primary-pri3 border border-neutral-neu1 rounded-xl w-full">
            <div className="flex flex-row items-center space-x-3">
                ...
                <div className="flex flex-col">
                    <h2 className="font-label text-label-md mt-1">
                        {nickname}
                    </h2>
            ...
            <div className="flex flex-col sm:flex-row items-center mt-4">
                <div className="flex flex-row">
                    <div className="group flex items-center hover:text-secondary-sec2">
                        <ButtonIcon
                            SvgIcon={
                                userInteraccion === "1" ? LikePressed : Like
                            }
