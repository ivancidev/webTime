  ...
  return (
    <div
      onClick={handleCardClick}
                // relative py-3 md:py-2 lg:h-[70px] rounded-xl flex flex-col items-center justify-center px-5 md:px-10 cursor-pointer hover:border-secondary-sec2 md:mr-7 lg:mr-12
