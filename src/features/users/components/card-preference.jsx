...
const CardPref = ({ text, icon, cod, onSelect, text2, isSelected }) => {
  ...
  const cardClassNames = `relative py-3 md:py-2 min-w-[122px] lg:h-[70px] rounded-xl flex flex-col items-center justify-center px-5 md:px-10 cursor-pointer hover:border-secondary-sec2 hover:text-secondary-sec2 md:mr-7 lg:mr-12 ${
    isSelected
