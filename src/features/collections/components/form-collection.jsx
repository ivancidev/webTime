...
export const FormCollection = () => {
  ...
  const onSubmit = async (data) => {
    ...
    if (addBooks.length === 0) {
      ...
      setOpenDialog(false);
      setErrorMessageBook("Selecciona al menos un libro para la colección.");
      return;
    }
    ...
    <div className="min-h-screen flex flex-col">
      <div className="flex flex-col items-center justify-center flex-grow">
        <form
          ...
          className="flex flex-col items-center w-full sm:px-12 px-0"
        >
          ...
          <div className="w-full p-10 mt-2">
              ...
              <div>
                ...
                <input
                  ...
                  {...register("nameCollection", {
                    required: "Debes introducir un nombre de colección",
                    pattern: {
            ...
            <div className="flex flex-wrap mt-2 mr-5 ml-0">
              ...
              <div
                ...
                className="w-[130px] h-40 mt-2 bg-neutral-neu2 rounded-2xl flex items-center justify-center hover:text-secondary-sec2 cursor-pointer hover:border hover:border-secondary-sec2 mr-5"
              >
                <AddLarge />
              </div>
            </div>
            <div className="h-7 mt-1">
              {errorMessageBook && (
                <span className="text-error-err2">{errorMessageBook}</span>
              )}
            </div>
          </div>
        </form>
      ...
      >
        {isLoading ? (
          ...
          <>
            ...
            <DialogContent className="flex flex-col items-center justify-center">
              <p>{errorMessage || "Ocurrió un error. Inténtalo de nuevo."}</p>
